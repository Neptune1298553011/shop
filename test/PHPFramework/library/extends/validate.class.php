...
class captcha{
    ...
    */
    static function generate($len=4,$font_size=48,$name='captcha',$width='',$height=''){
        if($width=='') $width=($font_size+3)*$len;
		...
		$font_path = ROOT_PATH . "common/common/fonts/Alpha-Silouette.ttf";
        imagettftext($image,$font_size,0,$font_size/2,$height/1.2,$text_color,$font_path,$str);//用规定字体向图像写入文本
